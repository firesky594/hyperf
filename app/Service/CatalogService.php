...
class CatalogService
{
    ...
    /** @return array{product_id:int,version_id:int} */
    ...
    /** @param list<array{method:string,path:string,name:string,description?:string}> $endpoints */
    ...
    /** @param list<object|array<string,mixed>> $rows @return list<array<string,mixed>> */
